...
export function Home() {
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center overflow-auto z-[5000] bg-slate-950 w-full"
      )}
    >
      <Navbar />
      ...
      <div className=" text-slate-400 text-5xl text-center mt-10 border border-slate-600 rounded-3xl py-16 px-16 mb-6 mx-16">
        Unlock the potential of digital ownership with Mercado
      </div>
      <div className="Details mx-16">
        ...
        <div className="flex mt-11">
          <div className="mx-6 my-6 text-center w-3/5">
            <AnimatedText blur={10} spread={2}>
              ...
              audience of collectors and enthusiasts. Whether you&apos;re
          ...
          <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                ...
                {/* <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Mercado</span> */}
              </div>
